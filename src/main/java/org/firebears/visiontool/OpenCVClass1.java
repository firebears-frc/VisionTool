...
public class OpenCVClass1 extends JPanel{
    ...
    public static void main (String args[]) throws InterruptedException{
        ...
        OpenCVClass1 t = new OpenCVClass1();
    ...
    public  OpenCVClass1(BufferedImage img) {
        image = img;
    }   
    ...
    public void window(BufferedImage img, String text, int x, int y) {
        ...
        frame0.getContentPane().add(new  OpenCVClass1(img));
